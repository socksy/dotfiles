(custom-set-variables
 ...
 '(highlight-tail-colors
   ((("#2e3737" "green" "green") . 0) (("#253542" "cyan" "blue") . 20)))
 ...
 '(safe-local-variable-values
   '((eval progn
      (defun habitatat-hotswap nil
       "Hot-swap habitatat Android app"
       (let
           ((default-directory
             (locate-dominating-file default-directory "flake.nix")))
         (compile "nix develop --command just hotswap")))
      (add-hook 'after-save-hook
       (lambda nil (when (derived-mode-p 'kotlin-mode) (habitatat-hotswap))) nil
       t))
     ...
     (eval define-clojure-indent (reg-cofx :defn) (reg-event-db :defn)
      ...
      (reg-event-domain-fx :defn) (When :defn) (Then :defn) (Given :defn)
      (And :defn) (this-as 0))
     (eval define-clojure-indent (reg-cofx :defn) (reg-event-db :defn)
      (reg-event-fx :defn) (reg-fx :defn) (reg-sub :defn)
      (reg-event-domain :defn) (reg-block-event-fx :defn)
 ...
 '(vc-annotate-color-map
   (list (cons 20 "#bae67e") (cons 40 "#d1e07e") (cons 60 "#e8da7f")
         (cons 80 "#ffd580") (cons 100 "#ffc573") (cons 120 "#ffb666")
         (cons 140 "#ffa759") (cons 160 "#f0af90") (cons 180 "#e2b7c7")
         (cons 200 "#d4bfff") (cons 220 "#deacd2") (cons 240 "#e899a5")
         (cons 260 "#f28779") (cons 280 "#bb6c63") (cons 300 "#84514e")
         (cons 320 "#4d3639") (cons 340 "#1c1e23") (cons 360 "#1c1e23")))
