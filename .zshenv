...
export PATH=$HOME/bin:$HOME/.moon/bin:$HOME/.npm-packages/bin:$HOME/.cargo/bin:$PATH:/sbin:$HOME/go/bin:$HOME/.config/emacs/bin:$HOME/.emacs.d/bin:/usr/local/bin:/opt/homebrew/bin:$HOME/.babashka/bbin/bin
